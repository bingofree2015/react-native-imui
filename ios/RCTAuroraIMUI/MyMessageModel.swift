    ...
    public convenience init(messageDic: NSMutableDictionary) {
        ...
        if let typeString = msgTypeString {
            if typeString == RCTMessageModel.kMsgTypeText {
                ...
                msgType = .video
                let url = messageDic.object(forKey: "url") as? String
                customDict.setValue(url, forKey: "url")
                let coverSizeWidth = messageDic.object(forKey: "coverSizeWidth") as? String
                customDict.setValue(coverSizeWidth, forKey: "coverSizeWidth")
                let coverSizeHeight = messageDic.object(forKey: "coverSizeHeight") as? String
                customDict.setValue(coverSizeHeight, forKey: "coverSizeHeight")
                let fileLength = messageDic.object(forKey: "fileLength") as? String
                customDict.setValue(fileLength, forKey: "fileLength")
                let duration = messageDic.object(forKey: "duration") as? String
                customDict.setValue(duration, forKey: "duration")
